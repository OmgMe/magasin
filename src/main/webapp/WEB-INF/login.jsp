                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Magasin</strong> Connexion</h1>
                            <div class="description">
                            	<p>
	                            	Identifiez-vous pour pouvoir effectuer des achats.
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>S'identifier</h3>
                            		<p>Inserez votre adresse email et votre mot de passe :</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="login" method="post" class="login-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="email" placeholder="Adresse email .." class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
